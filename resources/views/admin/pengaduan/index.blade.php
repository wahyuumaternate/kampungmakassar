@extends('admin.layouts.main',['title' => 'Pengaduan'])
@section('headerside')
                        ...
                        <div class="card shadow">
                            <div class="card-body">
                                <div class="card-header mb-3">
                                    <a href="{{ route('berita.tambah') }}" class="btn btn-primary"><i class="fe fe-send fe-16"></i> Pengaduan Terkirim</a>
                                </div>
                                <!-- table -->
                                    ...
                                    <tbody>
                                        @foreach ($pengaduan as $pengaduan)
                                            <tr>
                                                ...
                                                <td><a download="lampiran_pengaduan_{{ $pengaduan->nama }}" class="btn" href="{{ url('storage/' . $pengaduan->lampiran) }}"><i class="fe fe-download"></i> Download</a></td>
