...
<!-- ======= Surat Pengantar Pembuatan Kartu Tanda Penduduk (KTP) Section ======= -->
<section id="visi_misi" class="blog">
    <div class="container" data-aos="fade-up">
        <div class="section-title">
            <h2>Surat Pengantar Pembuatan Kartu Tanda Penduduk (KTP)</h2>
...
</section><!-- End Surat Pengantar Pembuatan Kartu Tanda Penduduk (KTP) Section -->
